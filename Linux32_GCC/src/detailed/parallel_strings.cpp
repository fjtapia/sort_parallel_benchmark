...
{ 
    ...
    switch (option)
    {
        case 1: cout << "GCC Sort (non stable sort)\n"; break;
        case 2: cout << "Boost Sort (non stable sort)\n"; break;
        case 3: cout << "GCC Stable Sort (stable sort)\n"; break;
        case 4: cout << "Boost Stable Sort (stable sort)\n"; break;
        case 5: cout << "Boost Spreadsort (non stable sort)\n"; break;
        case 6: cout << "GCC Parallel Sort (not stable sort)\n"; break;
        case 7: cout << "TBB Parallel Sort (not stable sort)\n"; break;
        case 8: cout << "Boost Parallel Sort (non stable sort)\n"; break;
        case 9: cout << "GCC Parallel Stable Sort (stable sort)\n"; break;
        case 10: cout << "Boost Parallel Stable Sort (stable sort)\n"; break;
        case 11: cout << "Boost Sample Sort (stable sort)\n"; break;
        case 12:
    ...
    A.clear();
    if (bs_util::fill_vector_string("input.bin", A, NELEM) != 0) {
